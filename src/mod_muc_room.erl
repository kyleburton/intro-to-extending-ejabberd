...
handle_event({add_message_to_history, FromNick, From, Packet}, StateName, StateData) ->
  {next_state, StateName, add_message_to_history(FromNick, From, Packet, StateData)};
